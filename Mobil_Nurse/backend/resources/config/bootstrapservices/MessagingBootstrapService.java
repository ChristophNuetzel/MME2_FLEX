...
public class MessagingBootstrapService extends AbstractBootstrapService
{
    ...
    private Service createService()
    {
        ...
        messageService.registerAdapter("cfgateway", "coldfusion.flex.CFEventGatewayAdapter");
        ...
        <properties>
            <network>
                ...
                <!--
                   ...
                   The inbound policy may be ERROR or IGNORE and the outbound policy may be ERROR, IGNORE, or REPLACE.
    ...
    */
    ...
    private void createDestination2(Service service)
    {
        ...
        jms.setDestinationName("FlexTopic");
