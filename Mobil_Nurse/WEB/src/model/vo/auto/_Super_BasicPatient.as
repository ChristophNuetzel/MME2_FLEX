 ...
 * of this value object you may modify the generated sub-class of this class - BasicPatient.as.
 */
...
[ExcludeClass]
public class _Super_BasicPatient extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("mobile.nurse.model.patient.BasicPatient") == null)
            {
                flash.net.registerClassAlias("mobile.nurse.model.patient.BasicPatient", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _BasicPatientEntityMetadata;
    ...
    public function _Super_BasicPatient()
    {
        _model = new _BasicPatientEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _BasicPatientEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _BasicPatientEntityMetadata) : void
    {
        var oldValue : _BasicPatientEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
