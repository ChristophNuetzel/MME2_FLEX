package view.components.splitview
{
	...
	public class RightSplitViewMediator extends Mediator implements IMediator
	{
		public static const NAME:String = "RightSplitViewNavigatorMediator";
		private var splitViewNavigator:ViewNavigator;
		private var patient:Patient;
		
		public function RightSplitViewMediator(splitViewNavigator:ViewNavigator , data:Patient)
		{
