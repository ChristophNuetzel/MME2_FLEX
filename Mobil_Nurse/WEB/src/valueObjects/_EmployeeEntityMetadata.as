...
internal class _EmployeeEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("id", "birth", "username", "name", "job", "firstname", "password", "prsnumber");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array();
    model_internal static var allAlwaysAvailableProperties:Array = new Array("id", "birth", "username", "name", "job", "firstname", "password", "prsnumber");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("id", "birth", "username", "name", "job", "firstname", "password", "prsnumber");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("id", "birth", "username", "name", "job", "firstname", "password", "prsnumber");
    ...
    public function _EmployeeEntityMetadata(value : _Super_Employee)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["prsnumber"] = new Array();
        ...
        model_internal::propertyTypeMap["prsnumber"] = "int";
    ...
    [Bindable(event="propertyChange")]
    public function get isPrsnumberAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get prsnumberStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
